...
@Component({
  selector: 'app-unverified-posts',
  templateUrl: './unverified-posts.component.html',
  styleUrls: ['./unverified-posts.component.css']
})
export class UnverifiedPostsComponent implements OnInit {
  ...
  getAllUnVerifiedPosts() {
    this.auth.getUnVerifiedPosts().subscribe(response => {
      this.unverifiedPosts = response;
    },
      (error: any) => {
        console.log(error);
      }
  ...
  verifyPost(){
    this.auth.verifyPost(this.verifyPostId).subscribe(response => {
      this.closeVerify();
      this.getAllUnVerifiedPosts();
    },
      (error: any) => {
  ...
  deletePost(){
    this.auth.deletePost(this.deletePostId).subscribe(response => {
      this.closeDelete();
      this.getAllUnVerifiedPosts();
    },
      (error: any) => {

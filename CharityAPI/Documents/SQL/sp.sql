...
ALTER PROCEDURE getAllPostLikeById(@postlikeid AS bit)
AS
BEGIN
    SELECT
		*
...
ALTER PROCEDURE getAllPostLikeByUserId(@userid AS bit)
AS
BEGIN
    SELECT
		*
...
ALTER PROCEDURE getNumberOfLike (@postid AS bit)
AS
BEGIN
	SELECT 
		COUNT(Likes) 
...
ALTER PROCEDURE getNumberOfDisLike (@postid AS bit)
AS
BEGIN
	SELECT 
		COUNT(DisLike) 
...
CREATE PROCEDURE getallVerifiedPost
AS
BEGIN
	SELECT 
		*
...
CREATE PROCEDURE getallUnVerifiedPost
AS
BEGIN
	SELECT 
		*
...
Exec getallVerifiedPost;
Exec getallUnVerifiedPost;
...
using CharityAPI.Errors;
using CharityAPI.IServices;
using CharityAPI.Middleware;
...
namespace CharityAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)  
        {
            ...
            services.AddTransient<IPostComments, PostCommentServices>();
            services.AddTransient<IBookmark, BookmarkServices>();
            ...
            services.AddTransient<IPostImages, PostImagesServices>();

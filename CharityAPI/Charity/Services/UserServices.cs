...
namespace CharityAPI.Services
{
    public class UserServices: GenericRepository<ApplicationUser>, IUser
    {
        ...
        public UserServices(CharityAPIContext context, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration, IMailService mailService) : base(context)
        {
        ...
        public void SendOTP(string userName)
        {
            ...
            var org = context.Users.SingleOrDefault(x => x.UserName == userName && x.IsPublished == true);
            org.Otp = otp;
            context.SaveChanges();

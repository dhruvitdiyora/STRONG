...
namespace CharityAPI.Services
{
    public class CharityEventInteractServices : GenericRepository<CharityEventInteract>, ICharityEventInteract
    {
        ...
        {
            var charityEventInteract = context.CharityEventInteract;
        ...
        public CharityEventInteract CheckInteract(long userid, long eventId)
        {
            var interact = context.CharityEventInteract.SingleOrDefault(x => x.UserId == userid && x.EventId == eventId);
            return interact;

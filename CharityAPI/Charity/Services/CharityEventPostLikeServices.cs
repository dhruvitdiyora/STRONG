...
namespace CharityAPI.Services
{
    public class CharityEventPostLikeServices : GenericRepository<CharityEventPostLike>, ICharityEventPostLike
    {
        ...
        public CharityEventPostLike CheckLike(long userid, long eventPostId)
        {
            var postLike = context.CharityEventPostLike.SingleOrDefault(x => x.UserId == userid && x.CharityEventPostId == eventPostId);
            return postLike;
